...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('./prod-description/prod-description.module').then(m => m.ProdDescriptionPageModule)
  },
  {
    path: 'terms',
  ...
  {
    path: 'identify-proof',
    loadChildren: () => import('./identify-proof/identify-proof.module').then(m => m.IdentifyProofPageModule)
  },
  {
    path: 'bank-details',
